namespace Domain.Common.Abstractions
{
    ...
    /// <summary>
    /// Marker interface for entity classes that support hard delete auditing
    /// </summary>
    ...
    /// </summary>
    public interface ICreatedUpdatedSoftDeleted : ICreatedUpdated, ISoftDeleted
    {
    }
    /// <summary>
    /// Maker for entity classes that support creation, update and hard delete auditing
    /// </summary>
    public interface ICreatedUpdatedDeleted : ICreatedUpdated, IDeleted
    {
    }
}